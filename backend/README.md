...
## Project Structure
    ...
    ├── testappspeeddoo_dev_46707  # Django project configurations
...
1. Clone this repo and `cd testappspeeddoo_dev_46707`
...
2. Clone this repo and `cd testappspeeddoo_dev_46707`
